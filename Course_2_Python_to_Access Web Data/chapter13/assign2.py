...
# is the actual data you need to process for the assignment.
    ...
    # Actual data: http://python-data.dr-chuck.net/comments_243380.json (Sum ends with 66)
...
# The closest sample code that shows how to parse JSON and extract a list is json2.py. You might also want to look at geoxml.py 
...
info1 = info['comments']
print ('Counts:', len(info1))
total = 0
for i in range(len(info1)):
    total = total + info1[i]['count']
print ("Sum: ", total)    

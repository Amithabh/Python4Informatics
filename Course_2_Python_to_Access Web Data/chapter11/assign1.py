...
# is the actual data you need to process for the assignment.
    ...
    # Actual data: http://python-data.dr-chuck.net/regex_sum_243374.txt (There are 78 values and the sum ends with 427)
...
# The sum for the sample text above is 27486. The numbers can appear anywhere in the line. There can be any number of numbers in 
# each line (including none).
...
# # There are a number of different ways to approach this problem. While we don't recommend trying to write the most compact code possible, 
# # it can sometimes be a fun exercise. Here is a a redacted version of two-line version of this program using list comprehension:
# # import re
# # print sum( [ ****** *** * in **********('[0-9]+',**************************.read()) ] )
# # Please don't waste a lot of time trying to figure out the shortest solution until you have completed the homework. List comprehension 
# # is mentioned in Chapter 10 and the read() method is covered in Chapter 7. 
